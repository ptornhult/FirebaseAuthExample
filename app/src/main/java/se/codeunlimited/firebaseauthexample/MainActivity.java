...
public class MainActivity extends LogActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            fragmentTransaction.replace(R.id.placeholder, new MainFragment());
        ...
        authViewModel.setLoggedIn(currentUser != null);
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            authViewModel.setLoggedIn(user != null);
                        } else {
